...
github <-
  contact_info %>% filter(loc == 'github')  %>% select(entry) %>% as.character()
```
...
-   <i class="fa fa-envelope"></i> [`r email`](`r hyperlink(paste0("mailto:",email))`){.email} 
-   <i class="fa fa-phone"> </i> `r phone`
-   [Linkedin: <i class="fa fa-linkedin"></i>](`r hyperlink(linkedin)`){target="_blank"} \  |  [Github: <i class='fa fa-github'></i>](`r hyperlink(github)`){target="_blank"}

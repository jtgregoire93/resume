...
-   Socials: [<i class="fa fa-linkedin"></i>](https://www.linkedin.com/in/justin-gregoire/){target="_blank"} | [<i class="fa fa-github"></i>](https://github.com/jtgregoire93){target="_blank"}

...
-   [![](svg/map-pin.svg){style="color:red" width="8%"}](https://goo.gl/maps/Kq3da8KnpZdFY6nd7) `r location %>% select(entry)`
-   [![](svg/envelope.svg){width="8%"}](mailto:jtgregoire93@gmail.com) `r email %>% select(entry) %>% as.character()`
-   [![](svg/phone.svg){width="8%"}](tel:+1757-619-7431) `r phone %>% select(entry)`
-   Socials: [![](svg/linkedin.svg){width="8%"}](https://www.linkedin.com/in/justin-gregoire) [![](svg/github.svg){width="8%"}](https://github.com/jtgregoire93). [![](svg/calendar-days.svg){width="8%"}](https://calendly.com/jtgregoire93/30-minute-call)

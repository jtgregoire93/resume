...
-   Socials:   [<i class="fa fa-github"> </i>](`r github %>% select(link) %>% hyperlink()` "Github"){target="_blank"}   [<i class="fa fa-linkedin"> </i>](`r linkedin %>% select(link) %>% hyperlink()` "Linkedin"){target="_blank"}   [<i class="fa fa-calendar"> </i>](`r calendly %>% select(link) %>% hyperlink()` "Availability via Calendly"){target="_blank"}

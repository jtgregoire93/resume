...
-   [<i class="fa fa-map-marker"> </i>](`r location %>% select(link) %>% hyperlink()`) `r location %>% select(entry)`
-   [<i class="fa fa-envelope"> </i>](`r email %>% select(link) %>% hyperlink()`) `r email %>% select(entry) %>% as.character()`
-   [<i class="fa fa-phone"> </i>](`r phone %>% select(link) %>% hyperlink()`) `r phone %>% select(entry)`
-   Socials:   [<i class="fa fa-github"> </i>](`r github %>% select(link) %>% hyperlink()`)   [<i class="fa fa-linkedin"> </i>](`r linkedin %>% select(link) %>% hyperlink()`)   [<i class="fa fa-calendar"> </i>](`r calendly %>% select(link) %>% hyperlink()`)

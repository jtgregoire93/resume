...
intro_text <- "**Data science professional with 6 years of experience empowering organizations with data and insights.** My professional expertise covers multiple areas: defining metrics and extracting insights with imperfect data; analyzing A/B experiments and using inferential statistics to deduce product impact and opportunity; and building data pipelines to support business intelligence.
